...
Main question I'm confused about: Should we expect there to be more features than neurons? Or maybe more precisely, when should we expect this to be the case? (E.g., does this differ between the underparametrized and overparametrized regime?) 
...
another idea: define special space to replace activation space https://arxiv.org/pdf/2302.03693.pdf