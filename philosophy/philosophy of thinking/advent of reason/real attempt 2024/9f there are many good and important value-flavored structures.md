...
2. All the following "structure kinds" are significantly value-flavored and important for determining what happens, and most/all of them have good instances/manifestations (and all of them surely also have bad manifestations)[^1]:
	...
	4. goal pursuits
	5. (local) optimization/minimization/maximization — in particular, maximizing the expectation of some variable
	6. improvement on a metric
	7. making the world have some property; aiming to bring something about; pushing the world in some direction
	8. trying to invent/create/make an object/event/device/concept which is supposed to meet a certain specification
	9. making use of a thing in accordance with its purpose
	10. playing roles, serving functions
	11. taking on responsibilities, being responsible for things
	12. accountability
	13. duty
	14. naturalness
	15. flow
	16. effortless action
	17. routines, habits
	18. etiquette, convention(s), custom(s), tradition(s), ritual(s), rites
	19. narrative continuation
	20. culture and associated structure( kind)s
	21. religion and associated structure( kind)s
	22. following orders; subjugation
	23. following rules; making rules; the categorical imperative
	24. having rights
	25. law(s); legal punishment
	26. integrity; honor
	27. reputation; status
	28. social approval/support/opposition; ostracism
	29. the economy; payment
	30. rewarding certain behaviors/results; reward structures in human brains/minds; backpropagation
	31. democracy, elections
	32. preferring; choosing among given options
	33. selection according to some criterion
	34. competition
	35. conflict; war
	36. politics; diplomacy
	37. critique; debate; discussion; negotiation; reconciliation
	38. being guided by reasons
	39. having (ethical) intuitions
	40. dispositions, inclinations, propensities, tendencies
	41. passion(s); emotion(s)
	42. cultivating/developing/maintaining character traits; also, various particular virtues and vices
	43. excellence
	44. identity creation/curation/development/maintenance; self-actualization, individuation; deciding whom to be; seeing oneself as someone
	45. homeostasis; self-preservation; autopoiesis; securing, protecting
	46. creating more options; seeking to have more options
	47. health and sickness(es)
	48. becoming more autonomous and free
	...
	55. the golden rule
	56. kindness
	57. fairness, equalizing
	58. justice
	59. respect
	60. empathy
	61. bringing into harmony/coherence
	62. aesthetics
	63. interest
	64. sincerity
	65. clarifying
	66. anxiety
	67. taking a step back and (re-)evaluating each particular structure of one of these kinds
	68. taking a step back and (re-)evaluating the totality of these structures
3. Many new items of these kinds (e.g., new projects to work on), as well as new value-flavored kinds, will probably emerge in the future.
4. Though we can surely work out many relations between the above structures, I'm skeptical of attempts that try to strongly subordinate all of these to a single one (or a few).
	1. These seem like genuinely important and often useful/good existing things that affect/"condition" each other in an at least somewhat non-hierarchical fashion (and I think things should indeed be this way to a significant extent).
5. In particular, one might attempt to make everything subservient to having some ultimate goal; I think this is mistaken (or at least that many versions of it are mistaken).
