...
> Random. Have digit $123456789$ of $\pi$ calculated.^[I'm using this instead of a coinflip because I think there's a significant chance that a coinflip is quantum-random: https://www.lesswrong.com/posts/9KW7oLQepcgu4LkFN/are-coin-flips-quantum-random-to-my-conscious-brain-parts .] If it is even, pursue $A$; if it is odd, pursue $B$.  
