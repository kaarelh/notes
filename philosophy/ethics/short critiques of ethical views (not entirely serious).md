...
* note first that preference utilitarianism has no view about how to live one's own life — about which base-level preferences to have oneself — even tho it does kinda determine one's all-things-considered preferences that i guess are to maximize the expected number/mass of base-preferences satisfied or something
* does it really intrinsically matter if someone's preference is satisfied when no one will ever interact with the object of their preference? like, wanting there to be a piano that fell into a black hole such that no one would ever find out? seems weird
* again, it seems really arbitrary to say that the only thing that matters is preference-satisfaction
