...
* Most of the notes are written for myself (to help me think some question through locally, to give me the option to reload a picture of some question later, and for other reasons). A significant fraction is written for sending to some friend(s). A significant fraction is written with potentially publishing partly in mind.
